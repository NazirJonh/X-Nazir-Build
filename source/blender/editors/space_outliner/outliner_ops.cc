...
void outliner_operatortypes()
{
  ...
  WM_operatortype_append(OUTLINER_OT_stack_layer_paste);
  ...
  WM_operatortype_append(OUTLINER_OT_stack_layer_image_drop);
  WM_operatortype_append(OUTLINER_OT_stack_layer_material_drop);
