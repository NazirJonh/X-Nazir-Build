...
SMOOTH(float3, layer_color)
SMOOTH(float3, preview_color)
...
PUSH_CONSTANT(float, layer_mask_opacity)
PUSH_CONSTANT(float3, layer_mask_tint)
PUSH_CONSTANT(float, layer_preview_threshold)
PUSH_CONSTANT(float, layer_preview_opacity)
PUSH_CONSTANT(float3, layer_preview_tint)
VERTEX_IN(0, float3, pos)
VERTEX_IN(1, float3, fset)
VERTEX_IN(2, float, msk)
VERTEX_IN(3, float, layer_weight)
VERTEX_IN(4, float, layer_preview)
