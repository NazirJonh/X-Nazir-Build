...
class _defs_image_paint_select:
    ...
    def box():
        def draw_settings(_context, layout, tool):
            props = tool.operator_properties("PAINT_OT_image_select_box")
            row = layout.row()
            row.use_property_split = False
            row.prop(props, "mode", text="", expand=True, icon_only=True)
    ...
    def lasso():
        def draw_settings(_context, layout, tool):
            props = tool.operator_properties("PAINT_OT_image_select_lasso")
            row = layout.row()
            row.use_property_split = False
            row.prop(props, "mode", text="", expand=True, icon_only=True)
    ...
    def circle():
        def draw_settings(_context, layout, tool):
            props = tool.operator_properties("PAINT_OT_image_select_circle")
            row = layout.row()
            row.use_property_split = False
            row.prop(props, "mode", text="", expand=True, icon_only=True)
            layout.prop(props, "radius")
    ...
    def invert():
        return dict(
            idname="PAINT_OT_image_select_invert",
    ...
    def all():
        return dict(
            idname="PAINT_OT_image_select_all",
            label="Select All",
    ...
    def none():
        return dict(
            idname="PAINT_OT_image_select_none",
            label="Deselect All",
