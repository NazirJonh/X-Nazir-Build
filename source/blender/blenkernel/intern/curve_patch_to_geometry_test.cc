...
{
  CurvePatchGeometry geometry;
  curve_patch_build_from_control_curve(make_poly_control_curve(3),
                                       make_params(),
                                       {},
                                       CurvePatchBuildMode::SurfaceWindowed,
                                       geometry);
...
TEST(paint_curve_patch_to_geometry, stamps_pointcloud_is_owned_nomain)
{
  ...
  curve_patch_build_from_control_curve(
      make_poly_control_curve(4), params, {}, CurvePatchBuildMode::SurfaceWindowed, geometry);
