...
def km_3d_view_tool_sculpt_extract_loop(params):
    return (
        "3D View Tool: Sculpt, Extract Loop",
        {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
        {"items": [
            ("sculpt.extract_loop_gesture", {"type": params.tool_mouse, "value": 'PRESS'}, None),
        ]},
    )


def km_3d_view_tool_sculpt_extract_region(params):
    return (
        "3D View Tool: Sculpt, Extract Region",
        {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
        {"items": [
            ("sculpt.extract_region", {"type": params.tool_mouse, "value": 'PRESS'}, None),
        ]},
    )
...
def generate_keymaps(params=None):
    ...
    return [
        ...
        *(km_3d_view_tool_select_lasso(params, fallback=fallback) for fallback in (False, True)),
        ...
        km_3d_view_tool_sculpt_extract_loop(params),
        km_3d_view_tool_sculpt_extract_region(params),
