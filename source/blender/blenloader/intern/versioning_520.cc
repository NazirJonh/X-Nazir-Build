...
void blo_do_versions_520(FileData * /*fd*/, Library * /*lib*/, Main *bmain)
{
  ...
  /* Note: version 502.48 used to zero `mtex.random_angle` on Curve Patch brushes, because STAMPS
   * mode read the amount without the #MTEX_ANGLE_RANDOM switch that gates it everywhere else.
