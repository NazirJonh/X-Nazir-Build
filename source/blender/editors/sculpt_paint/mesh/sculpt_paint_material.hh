...
/**
 * The color attribute names written by the enabled color-shaped channels (currently only Base
 * Color supports vertex paint), without duplicates. Mirrors #enabled_scalar_attribute_names;
 * shared by the brush and the undo push so both agree on exactly which attributes a stroke
 * touches.
 */
