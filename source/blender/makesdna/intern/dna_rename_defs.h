...
DNA_STRUCT_RENAME_MEMBER(ImageGridSlotDNA, enabled_catalog_paths, enabled_catalog_paths_legacy)
DNA_STRUCT_RENAME_MEMBER(ImageGridSlotDNA, library_type, library_type_legacy)
DNA_STRUCT_RENAME_MEMBER(ImageGridSlotDNA, library_custom_index, library_custom_index_legacy)
