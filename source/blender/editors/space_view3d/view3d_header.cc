...
static void uiTemplatePaintModeSelection(ui::Layout *layout, bContext *C)
{
  ...
  if (ob->mode == OB_MODE_SCULPT) {
    ...
    const char *active_tool_idname = active_tool != nullptr ? active_tool->idname : nullptr;
    if (mask_enabled ||
        BKE_paint_sculpt_face_selection_mask_supported(scene, ob, active_tool_idname))
    {
