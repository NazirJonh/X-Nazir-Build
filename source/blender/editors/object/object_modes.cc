...
static const char *object_mode_op_string(eObjectMode mode)
{
  ...
  if (mode == OB_MODE_VERTEX_CURVES) {
    return "CURVES_OT_vertex_paint_toggle";
  }
  return nullptr;
}
...
bool mode_compat_test(const Object *ob, eObjectMode mode)
{
  ...
  switch (ob->type) {
    ...
    case OB_ARMATURE:
      ...
      break;
    case OB_CURVES:
      if (mode & (OB_MODE_EDIT | OB_MODE_SCULPT_CURVES | OB_MODE_WEIGHT_CURVES | OB_MODE_VERTEX_CURVES)) {
        return true;
      }
      break;
