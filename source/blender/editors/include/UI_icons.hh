...
/* The same eight theme colors as above, over a plain folder instead of the Grease Pencil layer
 * group glyph — used by the sculpt layer tree, whose folders must keep their shape when tagged. */
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_01)
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_02)
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_03)
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_04)
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_05)
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_06)
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_07)
DEF_ICON_VECTOR(SCULPT_LAYERGROUP_COLOR_08)
