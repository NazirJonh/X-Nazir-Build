...
#define _DNA_DEFAULT_View3DOverlay \
  { \
    ...
    .show_weight_paint_symmetry_contour = true, \
    .show_vertex_paint_symmetry_contour = true, \
    .show_texture_paint_symmetry_contour = true, \
    .show_edit_mesh_symmetry_contour = true, \
    .show_curves_symmetry_plane = true, \
