...
static void rna_def_space_view3d_overlay(BlenderRNA *brna)
{
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "overlay.show_weight_paint_symmetry_contour", 0);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "overlay.show_vertex_paint_symmetry_contour", 0);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "overlay.show_texture_paint_symmetry_contour", 0);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "overlay.show_edit_mesh_symmetry_contour", 0);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "overlay.show_curves_symmetry_plane", 0);
  RNA_def_property_ui_text(
