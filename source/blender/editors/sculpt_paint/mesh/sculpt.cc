                          ...
                          float r_rgba[4])
{
  ...
  else if (mtex->brush_map_mode == MTEX_MAP_MODE_TRIPLANAR) {
  ...
  else if (mtex->brush_map_mode == MTEX_MAP_MODE_CUBE) {
  ...
  else if (mtex->brush_map_mode == MTEX_MAP_MODE_OCTAHEDRAL) {
  ...
  else if (mtex->brush_map_mode == MTEX_MAP_MODE_EQUAL_AREA) {
