 ...
 * this view actually built and laid out this frame", letting callers tell a genuine cursor-outside
 * result apart from a transient rebuild where the view has no tiles yet.
 */
