                                                     ...
                                                     const MutableSpan<float3> r_translations)
{
   ...
   * #StrokeCache.position_scale (which is right for a *distance*, e.g.
   * #calc_brush_distances_squared) would bend the direction toward the larger-scale axes, so it is
