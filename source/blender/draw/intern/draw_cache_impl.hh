...
/**
 * Add the active UV map to the layers the surface batches carry, without selecting a batch of its
 * own. Callers still request the surface batch through one of the getters above.
 */
