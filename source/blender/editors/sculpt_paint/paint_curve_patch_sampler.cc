...
CurvePatchSampler::CurvePatchSampler(const CurvePatchCache &patch,
    ...
    : patch_(patch),
      ...
      mask_(mask),
      tex_pool_(tex_pool),
      total_length_(patch.spline.total_length()),
...
{
  const CurvePatchCache &patch = patch_;
  const StrokeCache &cache = cache_;
