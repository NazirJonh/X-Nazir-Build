...
class PaintLayersUiTest(unittest.TestCase):
    ...
    def test_authored_fill_wires_the_default_channels(self):
        ...
        bottom = self.material.paint_layers.new(kind='PAINT', name="Bottom")
        self.set_default_maps(bottom)
        fill = self.material.paint_layers.new(kind='FILL', name="Fill")
    ...
    def test_authored_paint_participates_without_changing_the_render(self):
        ...
        paint = self.material.paint_layers.new(kind='PAINT', name="Paint")
    ...
    def test_folder_and_correction_get_no_default_channels(self):
        folder = self.material.paint_layers.new(kind='FOLDER', name="Folder")
        self.assertEqual(len(folder.channels), 0)
        layer = self.material.paint_layers.new(kind='PAINT', name="Layer")
        correction = layer.correction_add(section='CONTENT', effect='PAINT', name="C")
